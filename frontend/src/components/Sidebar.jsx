    ...
    return (
        <>
            ...
            <aside className={`
                ...
                ${isOpen ? 'w-1/6' : 'w-0 -translate-x-full lg:translate-x-0 lg:w-16'}
            ...
            `}>
                ...
                {isOpen && (
                    ...
                    <div className="text-xs font-semibold text-neutral-500 px-3 py-2">HISTORY</div>
                    
                    <button className="w-full flex items-center space-x-3 px-3 py-2 rounded-md hover:bg-neutral-800 text-neutral-100 text-sm transition">
                    ...
                    <div className="pt-4">
                        ...
                        <div className="space-y-1 mt-2">
                            <button className="w-full text-left px-3 py-2 rounded-md bg-neutral-800 hover:bg-neutral-700 text-sm text-neutral-100 transition">
